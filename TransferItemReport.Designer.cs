namespace Project
{
	partial class TransferItemReport
	{
		...
		private void InitializeComponent()
		{
			...
			this.TotalQuantityIn = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.TotalQuantityOut = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this.label6.Location = new System.Drawing.Point(432, 42);
			this.label6.Name = "label6";
			this.label6.Size = new System.Drawing.Size(192, 31);
			this.label6.TabIndex = 19;
			this.label6.Text = "Transfer Report";
			// 
			// dataGridView1
			// 
			...
			this.dataGridView1.Location = new System.Drawing.Point(525, 107);
			...
			// TotalQuantityIn
			// 
			this.TotalQuantityIn.HeaderText = "TotalQuantityIn";
			this.TotalQuantityIn.Name = "TotalQuantityIn";
			// 
			// TotalQuantityOut
			// 
			this.TotalQuantityOut.HeaderText = "TotalQuantityOut";
			this.TotalQuantityOut.Name = "TotalQuantityOut";
			// 
			// TransferItemReport
			// 
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn TotalQuantityIn;
		private System.Windows.Forms.DataGridViewTextBoxColumn TotalQuantityOut;
	}
}